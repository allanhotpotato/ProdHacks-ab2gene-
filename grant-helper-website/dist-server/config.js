...
export const RAG_EMBEDDING_MODEL = process.env.RAG_EMBEDDING_MODEL?.trim() || 'onnx-community/all-MiniLM-L6-v2-ONNX';
...
export const RAG_EMBEDDINGS_DISABLED = process.env.RAG_EMBEDDINGS_DISABLED === '1' || /^true$/i.test(process.env.RAG_EMBEDDINGS_DISABLED ?? '');
...
export const RAG_EMBEDDING_BATCH_SIZE = Math.max(1, Math.min(32, Number(process.env.RAG_EMBEDDING_BATCH_SIZE) || 8));
