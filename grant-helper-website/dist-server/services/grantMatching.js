...
export async function scoreGrantMatch(orgProfile, grantData) {
...
export async function quickEligibilityCheck(orgProfile, grantData) {
...
export async function generateApplicationTips(orgProfile, grantData, matchScore) {
